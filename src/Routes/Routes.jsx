  ...
  },
  {
    ...
    children: [

      {
        ...
        loader: ({ params }) => fetch(`https://the-news-dragon-server-ptan01.vercel.app/categories/${params.id}`)
      }
    ]
  },
  {
    ...
    children: [
      {
        ...
        loader: ({ params }) => fetch(`https://the-news-dragon-server-ptan01.vercel.app/news/${params.id}`)
      }
    ]
  }
]);
